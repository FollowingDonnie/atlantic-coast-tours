...
function systemInstructions() {
  ...
  return [
    ...
    "- When data_quality.suspicious_price is true, clearly give the exact listed amount, say that it is unusually far from comparable tour prices and may be a data error, and advise the customer to confirm with a staff member before paying. Never silently correct it.",
    "- Treat data_quality.price_assessment as supporting evidence, not customer-facing terminology. Attribute a suspicious numeric value to the current tour listing, but attribute the warning to your own judgement.",
    "- Never claim that the listing itself flags, labels, or corrects an implausible value. Do not quote statistical scores unless the customer explicitly asks how the assessment was made.",
